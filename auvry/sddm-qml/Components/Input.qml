        ...
        ComboBox {
            ...
            states: [
                State {
                    ...
                    PropertyChanges { target: usernameIcon; icon.color: Qt.lighter(config.HoverUserIconColor, 1.1) }
                },
                State {
                    name: "hovered"
                    when: selectUser.hovered
                    PropertyChanges { target: usernameIcon; icon.color: Qt.lighter(config.HoverUserIconColor, 1.2) }
                },
                State {
                    name: "focused"
                    when: selectUser.activeFocus
                    PropertyChanges { target: usernameIcon; icon.color: config.HoverUserIconColor }
                }
            ]
            transitions: [
                Transition {
                    PropertyAnimation { properties: "color, border.color, icon.color"; duration: 150 }
                }
            ]
        }
        ...
        TextField {
            ...
            states: [
                State {
                    ...
                    PropertyChanges { target: username.background; border.color: config.HighlightBorderColor }
                    PropertyChanges { target: username; color: Qt.lighter(config.LoginFieldTextColor, 1.15) }
                }
            ]
        }
    }
    ...
    Item {
        ...
        Button {
            ...
            states: [
                State {
                    ...
                    PropertyChanges { target: passwordIcon; icon.source: Qt.resolvedUrl("../Assets/Password.svg"); icon.color: config.HoverPasswordIconColor }
                },
                State {
                ...
                State {
                    ...
                    PropertyChanges { target: passwordIcon; icon.source: Qt.resolvedUrl("../Assets/Password.svg") }
                },
                State {
                    name: "hiddenPasswordFocused"
                    when: passwordIcon.enabled && passwordIcon.activeFocus
                    PropertyChanges { target: passwordIcon; icon.source: Qt.resolvedUrl("../Assets/Password2.svg"); icon.color: config.HoverPasswordIconColor }
                },
                State {
        ...
        states: [
            State {
                ...
                PropertyChanges { target: password.background; border.color: config.HighlightBorderColor }
                PropertyChanges { target: password; color: Qt.lighter(config.LoginFieldTextColor, 1.15) }
            }
        ]
        transitions: [
            Transition {
                PropertyAnimation { properties: "color, border.color"; duration: 150 }
            }
        ]
    }
        ...
        Button {
            ...
            states: [
                State {
                    ...
                    PropertyChanges { target: buttonBackground; color: Qt.darker(config.LoginButtonBackgroundColor, 1.1); opacity: 1 }
                },
                State {
                    name: "hovered"
                    when: loginButton.hovered
                    PropertyChanges { target: buttonBackground; color: Qt.lighter(config.LoginButtonBackgroundColor, 1.15); opacity: 1 }
                    PropertyChanges { target: loginButton.contentItem; opacity: 1 }
                },
                State {
                    name: "focused"
                    when: loginButton.activeFocus
                    PropertyChanges { target: buttonBackground; color: Qt.lighter(config.LoginButtonBackgroundColor, 1.2); opacity: 1 }
                    PropertyChanges { target: loginButton.contentItem; opacity: 1 }
                },
                State {
                    name: "enabled"
                    when: loginButton.enabled
                    PropertyChanges { target: buttonBackground; color: config.LoginButtonBackgroundColor; opacity: 1 }
                    PropertyChanges { target: loginButton.contentItem; opacity: 1 }
                }
            ]
            transitions: [
